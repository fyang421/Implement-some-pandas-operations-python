# -*- coding: utf-8 -*-
"""Copy of Quantexa_exercise_FengYang2.ipynb
...
# read transactions as dictionary
"""

import csv
with open('drive/My Drive/Colab notebooks/Quantexa exercise/transactions.txt') as file:
